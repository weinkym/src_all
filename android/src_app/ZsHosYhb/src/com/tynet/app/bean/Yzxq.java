...
public class Yzxq extends Base implements Serializable {
	...
	private String statusTime;// String 医嘱变更时间
	...
	private String stopTime;// String 停止时间 (这个医院真正停止的时间)
	...
	public static Yzxq parse(JSONObject jsonObject) throws JSONException{
		Yzxq yzxq = new Yzxq();
		...
		if(code.equals("0")){
			...
			yzxq.setStopTime(jsonYzxq.has("stopTime")?jsonYzxq.getString("stopTime"):"");
			yzxq.setPerformanceTime(jsonYzxq.has("performanceTime")?jsonYzxq.getString("performanceTime"):"");
