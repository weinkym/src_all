...
public class DocAdviceInfo extends Activity {
...
protected void onCreate(Bundle savedInstanceState) {
  ...
  private void init(){
	  ...
	  headTitle.setText(getString(R.string.long_yizhu_info));
	 ...
	 private class AdviceInfoTask extends GenericTask {
	           ...
	           // TaskParams param = params[0];
	            JSONObject paramJSON = new JSONObject();
						...
						try {
							...
							yzxq = appContext.getYzxq(paramJSON);
							if(yzxq.isSuccess()){
								msg = yzxq.getMessage();
	    ...
	    private TaskListener mAdviceInfoTaskListener = new TaskAdapter() {
	        ...
	        public String getName() {
	            return "DocAdviceInfo";
	        }
	    };
	    
	    private void onInitBegin() {
	    	TaskFeedback.getInstance(TaskFeedback.DIALOG_MODE, DocAdviceInfo.this).start("正在获取医嘱详情...");
	    }
	    
	    private void onInitSuccess() {
	    	TaskFeedback.getInstance(TaskFeedback.DIALOG_MODE, DocAdviceInfo.this).success();
	    	...
	    	stopExecuteTime.setText(StringUtils.toDate2(yzxq.getStopTime()));
...
//	    	operator.setText(yzxq.getYpgg());
	    	proofReader.setText(yzxq.getHdr());
	    }

	    private void onInitFailure(String reason) {
	    	TaskFeedback.getInstance(TaskFeedback.DIALOG_MODE, DocAdviceInfo.this).failed(reason);
