...
public class ListViewJcFangSheAdapter extends BaseAdapter{
	private Context 					context;//运行上下文
	private List<JcFangShe>				listItems;//数据集合
	...
	public ListViewJcFangSheAdapter(Context context, List<JcFangShe> data,int resource) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		//设置文字和图片
		JcFangShe itemList = listItems.get(position);       
		listItemView.pro_name.setText(itemList.getExamname());
//		listItemView.hospital_name.setText(patlist.getBah());
		listItemView.gather_time.setText("");
		listItemView.report_time.setText(StringUtils.toDate2(itemList.getApprovedate()));
		return convertView;		
	}
}
