...
public class ListViewJybgAdapter extends BaseAdapter{
	private Context 					context;//运行上下文
	private List<Jybg>					listItems;//数据集合
	...
	public ListViewJybgAdapter(Context context, List<Jybg> data,int resource) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		//设置文字和图片
		Jybg itemList = listItems.get(position);       
		listItemView.pro_name.setText(itemList.getSampletype());
//		listItemView.hospital_name.setText(patlist.getBah());
		listItemView.gather_time.setText(StringUtils.toDate2(itemList.getExecutetime()));
		listItemView.report_time.setText(StringUtils.toDate2(itemList.getChecktime()));
		return convertView;		
	}
}
