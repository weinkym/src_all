...
public class ListViewJcBingLiAdapter extends BaseAdapter{
	private Context 					context;//运行上下文
	private List<JcBingLi>				listItems;//数据集合
	...
	public ListViewJcBingLiAdapter(Context context, List<JcBingLi> data,int resource) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		//设置文字和图片
		JcBingLi itemList = listItems.get(position);       
		listItemView.pro_name.setText(itemList.getBglb());
//		listItemView.hospital_name.setText(patlist.getBah());
		listItemView.gather_time.setText("");
		listItemView.report_time.setText(itemList.getBgrq());
//		listItemView.gather_time.setText(StringUtils.toDate2(itemList.getBgrq()));
		return convertView;		
	}
}
