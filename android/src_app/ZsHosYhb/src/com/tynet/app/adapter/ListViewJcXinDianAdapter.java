...
public class ListViewJcXinDianAdapter extends BaseAdapter{
	private Context 					context;//运行上下文
	private List<JcXinDian>				listItems;//数据集合
	...
	public ListViewJcXinDianAdapter(Context context, List<JcXinDian> data,int resource) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		//设置文字和图片
		JcXinDian itemList = listItems.get(position);       
