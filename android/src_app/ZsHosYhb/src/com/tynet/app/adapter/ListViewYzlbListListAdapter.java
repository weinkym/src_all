 ...
 */
public class ListViewYzlbListListAdapter extends BaseAdapter {
	
	private Context 					context;//运行上下文
	private List<Yzlb>					listItems;//数据集合
	 ...
	 * @param resource
	 */
	public ListViewYzlbListListAdapter(Context context, List<Yzlb> data,int resource) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		//设置文字和图片
		Yzlb yzlblist = listItems.get(position);
		

       
		listItemView.time_start.setText(StringUtils.toDate2(yzlblist.getStartTime()));
		listItemView.time_stop.setText(StringUtils.toDate2(yzlblist.getStopTime()));
